...
import { MdClass, MdClose, MdDone } from "react-icons/md";
            ...
            >
                  ...
                  <div className="flex items-center justify-between gap-2">
                    {specialPrice ? (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="sm:text-xl font-semibold text-slate-50">
              ...
              <div className="px-6 py-4 flex justify-end gap-4">
                <button
                  ...
                  type="button"
                  className="px-4 py-2 text-sm font-semibold text-slate-700 border border-slate-700 hover:border-slate-800 rounded-md"
                >
                  close
                </button>
              </div>
